This repository contains 5 Python files containing problems of increasing difficulty. `1.py` represents the simplest problems and `5.py` represents the hardest problems.
